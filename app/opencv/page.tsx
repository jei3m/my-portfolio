      ...
      <main className="flex-grow container mx-auto px-4 py-8 flex flex-col items-center">
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden w-full max-w-3xl">
          <div className="relative w-full" style={{ paddingBottom: '141.4%' }}>
            <iframe 
              src="https://drive.google.com/file/d/1K21R-0lZe7SaPeHydEcm6cOqEYg195Iu/preview" 
        ...
        <p className="mt-4 text-center text-white">
          If the CV doesn't load, please <a href="https://drive.google.com/file/d/1K21R-0lZe7SaPeHydEcm6cOqEYg195Iu/view" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">click here</a> to view it directly.
        </p>
        <br/>
        <Link href="/home">
          <button
