...
export default function Projects() {
    return (
        <div className="p-8 flex flex-col overflow-x-hidden overflow-hidden w-full dark:bg-black bg-black dark: bg-dot-white/[0.2] relative flex items-center justify-center">
