...
export function ProjectCard3d({ title, type, description, imageUrl, githubUrl, demoUrl, skills }: ProjectCardProps) {
    return (
        <CardContainer className="inter-var w-full">
            <CardBody 
                className="md:mb-[-26px] bg-gray-900 relative group/card dark:hover:shadow-2xl dark:hover:shadow-gray-500/[0.1] border-1 border-white/[0.4] w-full max-w-[430px] mx-auto h-auto rounded-xl p-4 text-white"
            >
