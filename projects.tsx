      ...
      <div className="flex flex-col w-full max-w-[1100px]">
        <main className="max-w-7xl mx-auto px-4 py-16">
          <h2
            ...
            className="mb-5 font-extrabold tracking-tight text-4xl lg:text-4xl text-left w-full z-80"
          >
            Projects
          </h2>
              ...
              <Card key={index} className="bg-gray-900 border-white flex flex-col h-full">
                ...
                <CardContent className="p-4 pt-0 flex-grow">
                  <div className="flex flex-wrap gap-3">
                    {project.skills.map((skill, skillIndex) => (
                      <span
                        key={skillIndex}
                        className="text-sm px-3 py-2 bg-gray-800 text-gray-300 rounded-md"
                      >
                        {skill}
                      </span>
                    ))}
                ...
                <CardFooter className="p-4 pt-0 flex justify-between gap-6 mt-auto">
                  <a
                    ...
                    className="flex items-center gap-3 text-base bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md transition-colors"
                  >
                    <Github size={20} />
                    Code
                  </a>
                  {project.demoUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 text-base bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-md transition-colors"
                    >
